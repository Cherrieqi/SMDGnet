...
work_dir = f"./work_dir/Wetland_inch9_w3-6-1-1_b1024_lr0.002/{seed}/"
batch_size = 4096
...
SE_img = np.load("data/Wetland/gen_ZY1YC/SE_img.npy")
img = np.load("data/Wetland/gen_ZY1YC/img.npy")
label = np.load("data/Wetland/gen_ZY1YC/gt.npy")
...
with open(result_save_path + str("wetland") + "results.txt", 'a') as f:
