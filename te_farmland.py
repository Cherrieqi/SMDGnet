...
work_dir = f"./work_dir/Farmland_inch9_w3-6-1-1_b1024_lr0.001/{seed}/"
...
SE_img = np.load("data/Farmland/gen_LK/SE_img.npy")
img = np.load("data/Farmland/gen_LK/img.npy")
label = np.load("data/Farmland/gen_LK/gt.npy")
...
with open(result_save_path + str("farmland") + "results.txt", 'a') as f:
